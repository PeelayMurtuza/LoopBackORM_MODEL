...
export class OrderManufacturerController {
  ...
  async find(
    ...
    return this.orderRepository.manufacturer(id).find(filter);
  }
  ...
  async create(
    ...
    return this.orderRepository.manufacturer(id).create(manufacturer);
  }
  ...
  async patch(
    ...
    return this.orderRepository.manufacturer(id).patch(manufacturer, where);
  }
  ...
  async delete(
    ...
    return this.orderRepository.manufacturer(id).delete(where);
  }
}
