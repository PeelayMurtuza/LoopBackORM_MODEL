...
> {
  ...
  public readonly manufacturer: HasManyRepositoryFactory<Manufacturer, typeof Order.prototype.order_id>;
  ...
  constructor(
    ...
    this.manufacturer = this.createHasManyRepositoryFactoryFor('manufacturer', manufacturerRepositoryGetter,);
